...
<a href="https://ljapps.com/wp-review-slider-pro/" class="btn_green dashicons-before dashicons-external"><?php _e('Get Pro Version Here!', 'wp-fb-reviews'); ?></a>

<ul style="
    list-style-type: circle;
    margin-left: 30px;
">
	<li>Grab all your reviews with our new Review Funnels feature!</li>
	<li>Customer support via email and a forum.</li>
	<li>Download and display the review titles!</li>
	<li>Front end submission form.</li>
	<li>The read more link expands text and keeps the user on the page.</li>
	<li>Get email notifications when new low reviews are found.</li>
	<li>Download your Yelp, Facebook, and Google reviews as well!</li>
	...
	<li>Only display reviews of a certain type (Facebook, Yelp, Google, manually input).</li>
...
<div class="w3_wprs-row">
							<div class="w3_wprs-col s4">
							  <style>.wptripadvisor_t1_DIV_2::after{ border-top: 30px solid #fdfdfd; }.wptripadvisor_t1_DIV_1 {margin: 5px;}a {
    text-decoration: none;
}</style>
							  <div class="w3_wprs-col">
							  <div class="wptripadvisor_t1_DIV_1">	
							  <div class="wptripadvisor_t1_DIV_2 wprev_preview_bg1 wprev_preview_bradius" style="border-radius: 0px; background: rgb(253, 253, 253);">										<p class="wptripadvisor_t1_P_3 wprev_preview_tcolor1" style="color: rgb(85, 85, 85);">											<span class="wptripadvisor_star_imgs"><img src="https://ljapps.com/wp-content/plugins/wp-review-slider-pro-premium/public/partials/imgs/stars_5_yellow.png" alt="">&nbsp;&nbsp;</span>Great for my site! Good choice of styles & formats, easy to use. Show cases our 5* (others if required) reviews from Facebook & Google+ easy to update. Good all round plugin.</p>									</div><span class="wptripadvisor_t1_A_8"><img src="https://s3-us-west-2.amazonaws.com/freemius/plugins//reviews/c8174af85095ea546c03cddd103abfd2.jpg" alt="thumb" class="wptripadvisor_t1_IMG_4"></span> <span class="wptripadvisor_t1_SPAN_5 wprev_preview_tcolor2" style="color: rgb(85, 85, 85);">Antony Bowers<br>Director, <a href="https://www.sweetfantasies.co.uk" target="_blank">Sweet Fantasies Cakes </a><br><span id="wprev_showdate"></span> </span>								
							  </div>								
							  </div>
							</div>
							<div class="w3_wprs-col s4">
							  <div class="w3_wprs-col">							
							  <div class="wptripadvisor_t1_DIV_1">									
							  <div class="wptripadvisor_t1_DIV_2 wprev_preview_bg1 wprev_preview_bradius" style="border-radius: 0px; background: rgb(253, 253, 253);">										<p class="wptripadvisor_t1_P_3 wprev_preview_tcolor1" style="color: rgb(85, 85, 85);">											<span class="wptripadvisor_star_imgs"><img src="https://ljapps.com/wp-content/plugins/wp-review-slider-pro-premium/public/partials/imgs/stars_5_yellow.png" alt="">&nbsp;&nbsp;</span>Great product, great support! Love this product and the support received has been amazing and fast.</p>									</div><span class="wptripadvisor_t1_A_8"><img src="https://s3-media2.fl.yelpcdn.com/assets/srv0/yelp_styleguide/514f6997a318/assets/img/default_avatars/user_60_square.png" alt="thumb" class="wptripadvisor_t1_IMG_4"></span> <span class="wptripadvisor_t1_SPAN_5 wprev_preview_tcolor2" style="color: rgb(85, 85, 85);">Russ Kemp<br>Owner, <a href="https://www.russkempphotography.com" target="_blank">Russ Kemp Photography </a><br><span id="wprev_showdate"></span> </span>								</div>								
							  </div>
							</div>
						  <div class="w3_wprs-col s4">
							  <div class="w3_wprs-col">							
							  <div class="wptripadvisor_t1_DIV_1">
							  <div class="wptripadvisor_t1_DIV_2 wprev_preview_bg1 wprev_preview_bradius" style="border-radius: 0px; background: rgb(253, 253, 253);">										<p class="wptripadvisor_t1_P_3 wprev_preview_tcolor1" style="color: rgb(85, 85, 85);">											<span class="wptripadvisor_star_imgs"><img src="https://ljapps.com/wp-content/plugins/wp-review-slider-pro-premium/public/partials/imgs/stars_5_yellow.png" alt="">&nbsp;&nbsp;</span>Exactly what I needed. Excellent support as well.		</p>									</div><span class="wptripadvisor_t1_A_8"><img src="https://www.gravatar.com/avatar/950af451288353b2525a0064e4e95efa?size=75&default=https%3A%2F%2Fdashboard.freemius.com%2Fassets%2Fimg%2Ffs%2Fprofile-pics%2Fprofile-pic-2.png" alt="thumb" class="wptripadvisor_t1_IMG_4"></span> <span class="wptripadvisor_t1_SPAN_5 wprev_preview_tcolor2" style="color: rgb(85, 85, 85);">C.J. Ware<br><span id="wprev_showdate"></span> </span>								</div>								
							  </div>
						  </div>
					</div>
	</br>
